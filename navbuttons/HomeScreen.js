      ...
      <View style={styles.fillOut}>
        ...
        <View style={styles.topContainers}>
          ...
          <Pressable style={styles.containerBox1}>
            ...
            <Text style={styles.bottomText}>Hydrogen Sulfide</Text>
          </Pressable>
          {/* Container 2 */}
          <Pressable style={styles.containerBox2} >
            <View style={styles.innerContainer}/>
            <Text style={styles.bottomText}>Carbon Monoxide</Text>
          </Pressable>
        </View>
        ...
        <View style={styles.bottomContainers}>
          ...
          <Pressable style={styles.containerBox3} >
            <View style={styles.innerContainer}/>
            <Text style={styles.bottomText}>GPS</Text>
          </Pressable>
          {/* Container 4 */}
          <Pressable style={styles.containerBox4} >
            <View style={styles.innerContainer}/>
            <Text style={styles.bottomText}>Methane</Text>
          </Pressable>
        </View>
      </View>
    </View>
